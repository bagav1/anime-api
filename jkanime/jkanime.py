...
#     ListAnime,
# )
from jkanime.utils import parse_table, removeprefix, safe_strip
...
class JKAnime(object):
    ...
    def get_anime_info(self, id: str):
        ...
        information = {
            "id": container.select_one("div.anime__details__title h3").text,
        ...
        for i in range(len(pagination_ep)):
            id = information["unique_id"]
            resp=self._scraper.get(f"{PAGINATION_EP}/{id}/{i + 1}", headers={"Referer": BASE_URL})
